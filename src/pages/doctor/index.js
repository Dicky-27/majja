...
function Dokter() {
  ...
  const filterday = (value) => {
    ...
    DataJadwalDokter.map(
      (item, i) =>
        item.hari == value &&
        temp.indexOf(item.id_dokter) < 0 &&
        temp.push(item.id_dokter)
    );

    let filteredData = [];
    DataDokterMaster.map(
      (dktr, i) => temp.indexOf(dktr.id_dokter) > -1 && filteredData.push(dktr)
    );
          ...
          <div className="filter p-2 my-3">
            <div className="row align-items-center my-1 px-5">
              <div className="col-xl-4 col-md-6 col-12 py-2 px-3">
                <span className="py-3">
                  <b>Cari berdasarkan nama dokter</b>
                </span>
                <Search
                  className="py-1"
              ...
              <div className="col-xl-3 col-md-6 col-12 px-3">
                ...
                >
                  ...
                  <Option value="Spesialis Obstetri dan Ginekologi">
