...
function Setting() {
  const [email, setEmail] = useState(
    Cookies.get("email") != undefined ? Cookies.get("email").split('"')[1] : ""
  );
  ...
  return (
    <>
      <Wrapper className="container-fluid">
        <div className="row">
          <div className="col-6">
            <StyledTitle>Pengaturan</StyledTitle>
          </div>
        </div>
                ...
                <div className="">
                  {
                    imagePreview ? (
                      ...
                      // (imgawal ?
                      <Image
                        src={imgawal ? imgawal : "/images/imgplaceholder.svg"}
                        width={105}
                        height={140}
                        alt="upload"
                        style={{ objectFit: "cover", borderRadius: "5px" }}
      ...
      >
        <div className="p-3">
          <h5 className="pb-3 modalDoctorTitle" style={{ fontSize: "16px" }}>
            Masukkan Password Lama untuk Mengkonfirmasi Perubahan
          </h5>
